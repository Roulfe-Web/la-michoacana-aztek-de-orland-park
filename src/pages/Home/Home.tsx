...
function Home() {
    return (
        <>
            ...
            <div className="flex flex-col md:flex-row justify-center items-center gap-14 bg-azul text-gray-300">
                <p>Made by <span className="hover:hover-rosa">Roulfe</span></p>
            </div>
        </>
    );
}
